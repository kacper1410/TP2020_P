...
namespace Task3Tests
{
    ...
    public class QueriesTest
    {
        ...
        {
            List<Product> products = Queries.GetProductsByName("Paint");
        ...
        {
            List<Product> products = Queries.GetProductsByVendorName("Speed Corporation");
        ...
        {
            List<string> productNames = Queries.GetProductNamesByVendorName("Speed Corporation");
        ...
        {
            string vendorName = Queries.GetProductVendorByProductName("Short-Sleeve Classic Jersey, S");
		...
		{
			List<Product> products = Queries.GetProductsWithNRecentReviews(3);
		...
		{
            List<Product> products = Queries.GetNRecentlyReviewedProducts(3);
        ...
        public void GetProductCategoryByNameTest()
        {
            ...
            ProductCategory productCategory = Queries.GetProductCategoryByName("Clothing");
        ...
        public void GetTotalStandardCostByCategoryTest()
        {
            ...
            int costs = Queries.GetTotalStandardCostByCategory(Queries.GetProductCategoryByName("Clothing"));
